...
\begin{example}[A Derivative Formula]
  ...
  The kernel is $K(\theta) = e_L\big((x-\theta)_+^2\big)$. Since $\tfrac{d}{dx}(x-\theta)_+^2 = 2(x-\theta)_+$, the derivative term contributes $2(0-\theta)_+ = 0$ for $\theta \ge 0$, as does the $f(0)$ term. So
  $$
