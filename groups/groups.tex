...
\begin{proposition}[Subset Conjugation is an Action]
	A group $G$ acts by conjugation on the set of its subgroups. The singleton orbits are the normal subgroups.
\end{proposition}
\begin{proof}[Sketch]
	Check definitions, and recall that $N \normal G \iff \forall g \in G, g N g^{-1} = N$.
\end{proof}
