...
For self-adjoint operators on a Hilbert space the spectrum is far better behaved, and the picture becomes much closer to the finite-dimensional one: the spectrum is real, there is no residual part, and the extreme points of the spectrum are exactly the extreme values of the quadratic form $v \mapsto \ip{Tv}{v}$.
