...
\begin{definition}
	For $a, b \in \N$, we say $c$ is the \vocab{greatest common divisor} of $a$ and $b$ if $c$ is a common factor, that is, $c \mid a$ and $c \mid b$, and if $d \mid a$ and $d \mid b$ then $d \mid c$. We write $\gcd(a, b) = c$.
\end{definition}
...
\begin{example}[Using the Eucldiean Algorithm]
