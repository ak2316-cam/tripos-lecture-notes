...
\begin{tikzpicture}[scale=0.94, transform shape]
	\draw[blob] (-5.6,-3.0) rectangle (5.6,3.0);
	\draw[thick] (-0.9,0) ellipse (4.5 and 2.5);
	\draw[thick] (-1.6,0) ellipse (3.65 and 2.1);
	\draw[thick] (-2.3,0) ellipse (2.8 and 1.7);
	\draw[thick] (-3.0,0) ellipse (1.95 and 1.25);
	\node[font=\footnotesize] at (-3.0,0) {type $3$};
	\node[font=\footnotesize] at (-0.28,0) {type $2$};
	\node[font=\footnotesize] at (1.28,0) {type $1$};
	\node[font=\footnotesize] at (2.83,0) {type $0$};
	\node[font=\footnotesize] at (-4.4,2.65) {all languages};
	\node[font=\footnotesize] at (-2.3,-1.45) {$\{0^k1^k\}$};
	\node[font=\footnotesize] at (0.39,-1.3) {$\{a^nb^nc^n\}$};
	\node[font=\footnotesize] at (2.10,-1.3) {$\KK$};
	\node[font=\footnotesize] at (4.30,-1.3) {$\WW \setminus \KK$};
\end{tikzpicture}
\end{center}
...
\begin{example}\label{ex:subsetworked}
	...
	\begin{tikzpicture}
		...
		\draw[tra, rounded corners=7pt] (Z) -- (4.8,-1.75) -- node[tlab, below] {$b$} (0,-1.75) -- (X);
		\end{scope}
	\end{tikzpicture}
	\end{center}
...
\begin{tikzpicture}[scale=0.95, transform shape]
	...
	\foreach \i/\s in {0/a, 1/a, 2/b, 3/b, 4/a, 5/b, 6/{}} {
		\draw[thick] (\i*0.75, 2.6) rectangle (\i*0.75+0.75, 3.3);
		\node[font=\small] at (\i*0.75+0.375, 2.95) {$\s$};
	}
	\node[font=\footnotesize, anchor=east] at (-0.2,2.95) {input};
	\draw[tra] (1.875,2.55) -- (1.875,1.75);
	\node[font=\footnotesize, anchor=west] at (1.98,2.15) {reading head};
	% control
	\draw[blob, fill=none] (0.3,0.5) rectangle (3.5,1.7);
	\node[font=\small] at (1.9,1.31) {finite control};
	\node[font=\small] at (1.9,0.86) {state $q$};
	% stack
	\foreach \i/\s in {0/{\$}, 1/{Z}, 2/{Z}, 3/{Y}} {
		\draw[thick] (5.4, \i*0.55+0.1) rectangle (6.3, \i*0.55+0.65);
		\node[font=\small] at (5.85, \i*0.55+0.375) {$\s$};
	}
	\draw[thick, dashed] (5.4,-0.45) rectangle (6.3,0.1);
	\node[font=\footnotesize, anchor=west] at (6.45,2.05) {top of stack};
	\node[font=\footnotesize, anchor=west] at (6.45,-0.18) {bottom};
	% arrows between control and stack
	\draw[tra] (3.6,1.45) -- node[tlab, above] {\footnotesize push / pop} (5.3,1.45);
	\draw[tra] (5.3,0.75) -- node[tlab, below] {\footnotesize top symbol} (3.6,0.75);
\end{tikzpicture}
\end{center}
...
\begin{center}
\begin{tikzpicture}[scale=0.94, transform shape]
	\draw[blob] (-6.6,-3.3) rectangle (6.6,3.3);
	\draw[thick] (-1.15,0) ellipse (5.3 and 2.75);
	\draw[thick] (-1.9,0) ellipse (4.4 and 2.35);
	\draw[thick] (-2.65,0) ellipse (3.5 and 1.95);
	\draw[thick] (-3.4,0) ellipse (2.6 and 1.55);
	\draw[thick] (-4.15,0) ellipse (1.7 and 1.1);
	\node[font=\footnotesize] at (-4.15,0) {type $3$};
	\node[font=\footnotesize] at (-1.62,0) {type $2$};
	\node[font=\footnotesize] at (0.02,0) {type $1$};
	\node[font=\footnotesize] at (1.67,0) {$\Delta_1$};
	\node[font=\footnotesize] at (3.32,0) {$\Sigma_1$};
	\node[font=\footnotesize] at (-5.3,2.95) {all languages};
	\node[font=\footnotesize] at (-3.4,-1.3) {$\{0^k1^k\}$};
	\node[font=\footnotesize] at (-0.74,-1.15) {$\{a^nb^nc^n\}$};
	\node[font=\footnotesize] at (1.06,-1.15) {$\mathbb{D}$};
	\node[font=\footnotesize] at (2.80,-1.15) {$\KK$};
	\node[font=\footnotesize] at (5.13,-1.15) {$\WW\setminus\KK$};
\end{tikzpicture}
\end{center}
